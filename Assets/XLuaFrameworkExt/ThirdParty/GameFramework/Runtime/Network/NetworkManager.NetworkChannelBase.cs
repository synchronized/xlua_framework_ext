...
namespace GameFramework.Network
{
    public partial class NetworkManager : INetworkManager
    {
        ...
        public abstract class NetworkChannelBase : INetworkChannel, IDisposable
        {
            ...
            protected readonly EventPool<NetworkEventArgs> m_NetworkEventPool;
            public Action<NetworkConnectedEventArgs> NetworkChannelConnected;
            public Action<NetworkClosedEventArgs> NetworkChannelClosed;
            public Action<NetworkMissHeartBeatEventArgs> NetworkChannelMissHeartBeat;
            public Action<NetworkErrorEventArgs> NetworkChannelError;
            public Action<NetworkCustomErrorEventArgs> NetworkChannelCustomError;
            ...
            public NetworkChannelBase(string name, INetworkChannelHelper networkChannelHelper)
            {
                ...
                m_NetworkEventPool = new EventPool<NetworkEventArgs>(EventPoolMode.Default);
                m_NetworkEventPool.SetDefaultHandler(OnNetworkChannelEvent);
            ...
            {
                m_NetworkEventPool.Update(elapseSeconds, realElapseSeconds);
                ...
                if (m_HeartBeatInterval > 0f)
                {
                    ...
                    if (sendHeartBeat && m_NetworkChannelHelper.SendHeartBeat())
                    {
                        ...
                        {
                            OnNetworkChannelMissHeartBeat(this, missHeartBeatCount);
                        }
                    }
                }
            }
            ...
            public virtual void Connect(IPAddress ipAddress, int port, object userData)
            {
                ...
                switch (ipAddress.AddressFamily)
                {
                    ...
                    default:
                        string errorMessage = string.Format("Not supported address family '{0}'.", ipAddress.AddressFamily);
                        if (NetworkChannelError != null)
                        {
                            OnNetworkChannelError(this, NetworkErrorCode.AddressFamilyError, SocketError.Success, errorMessage);
                            return;
                        }
            ...
            {
                Connect(IPAddress.Parse(ipAddress), port, null);
            }

            public void Connect(string ipAddress, int port, object userData)
            {
                Connect(IPAddress.Parse(ipAddress), port, userData);
            }
            ...
            public void Send(Packet packet)
            {
                if (m_Socket == null)
                {
                    ...
                    if (NetworkChannelError != null)
                    {
                        OnNetworkChannelError(this, NetworkErrorCode.SendError, SocketError.Success, errorMessage);
                        return;
                    }
                ...
                while (m_SendPacketPool.Count > 0)
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        if (NetworkChannelError != null)
                        {
                            ...
                            OnNetworkChannelError(this, NetworkErrorCode.SerializeError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                            return false;
                        }
                    ...
                    if (!serializeResult)
                    {
                        ...
                        if (NetworkChannelError != null)
                        {
                            OnNetworkChannelError(this, NetworkErrorCode.SerializeError, SocketError.Success, errorMessage);
                            return false;
                        }
            ...
            protected virtual bool ProcessPacketHeader()
            {
                try
                {
                    ...
                    {
                        OnNetworkChannelCustomError(this, customErrorData);
                    }
                    ...
                    if (packetHeader == null)
                    {
                        ...
                        if (NetworkChannelError != null)
                        {
                            OnNetworkChannelError(this, NetworkErrorCode.DeserializePacketHeaderError, SocketError.Success, errorMessage);
                            return false;
                        }
                ...
                catch (Exception exception)
                {
                    ...
                    {
                        SocketException socketException = exception as SocketException;
                        OnNetworkChannelError(this, NetworkErrorCode.DeserializePacketHeaderError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return false;
                    }
            ...
            protected virtual bool ProcessPacket()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    {
                        SocketException socketException = exception as SocketException;
                        OnNetworkChannelError(this, NetworkErrorCode.DeserializePacketError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return false;
                    }
            ...
            protected void OnNetworkChannelConnected(INetworkChannel networkChannel, object userData)
            {
                NetworkConnectedEventArgs args = NetworkConnectedEventArgs.Create(networkChannel, userData);
                m_NetworkEventPool.Fire(this, args);
            }

            protected void OnNetworkChannelClosed(NetworkChannelBase networkChannel)
            {
                NetworkClosedEventArgs args = NetworkClosedEventArgs.Create(networkChannel);
                m_NetworkEventPool.Fire(this, args);
            }

            protected void OnNetworkChannelMissHeartBeat(NetworkChannelBase networkChannel, int missHeartBeatCount)
            {
                NetworkMissHeartBeatEventArgs args = NetworkMissHeartBeatEventArgs.Create(networkChannel, missHeartBeatCount);
                m_NetworkEventPool.Fire(this, args);
            }

            protected void OnNetworkChannelError(NetworkChannelBase networkChannel, NetworkErrorCode errorCode, SocketError socketErrorCode, string errorMessage)
            {
                NetworkErrorEventArgs args = NetworkErrorEventArgs.Create(networkChannel, errorCode, socketErrorCode, errorMessage);
                m_NetworkEventPool.Fire(this, args);
            }

            protected void OnNetworkChannelCustomError(NetworkChannelBase networkChannel, object customErrorData)
            {
                NetworkCustomErrorEventArgs args = NetworkCustomErrorEventArgs.Create(networkChannel, customErrorData);
                m_NetworkEventPool.Fire(this, args);
            }

            protected void OnNetworkChannelEvent(object sender, NetworkEventArgs networkArgs) {
                if (networkArgs is NetworkConnectedEventArgs) {
                    var args = networkArgs as NetworkConnectedEventArgs;
                    NetworkChannelConnected(args);
                    ReferencePool.Release(args);
                    return;
                }
                if (networkArgs is NetworkClosedEventArgs) {
                    var args = networkArgs as NetworkClosedEventArgs;
                    NetworkChannelClosed(args);
                    ReferencePool.Release(args);
                    return;
                }
                if (networkArgs is NetworkMissHeartBeatEventArgs) {
                    var args = networkArgs as NetworkMissHeartBeatEventArgs;
                    NetworkChannelMissHeartBeat(args);
                    ReferencePool.Release(args);
                    return;
                }
                if (networkArgs is NetworkErrorEventArgs) {
                    var args = networkArgs as NetworkErrorEventArgs;
                    NetworkChannelError(args);
                    ReferencePool.Release(args);
                    return;
                }
                if (networkArgs is NetworkCustomErrorEventArgs) {
                    var args = networkArgs as NetworkCustomErrorEventArgs;
                    NetworkChannelCustomError(args);
                    ReferencePool.Release(args);
                    return;
                }

                var errorMessage = $"unknown networkArgs type networkArgs:{networkArgs.GetType().FullName}";
                throw new GameFrameworkException(errorMessage);
            }
        }
    }
