...
namespace GameFramework.Network
{
    public partial class NetworkManager : INetworkManager
    {
        ...
        /// 使用同步接收的 TCP 网络频道。
        /// </summary>
        public sealed class TcpWithSyncReceiveNetworkChannel : NetworkChannelBase
        {
            ...
            internal TcpWithSyncReceiveNetworkChannel(string name, INetworkChannelHelper networkChannelHelper)
            ...
            public override void Connect(IPAddress ipAddress, int port, object userData)
            {
                ...
                if (m_Socket == null)
                {
                    ...
                    {
                        OnNetworkChannelError(this, NetworkErrorCode.SocketError, SocketError.Success, errorMessage);
                        return;
                    }
            ...
            private void ConnectAsync(IPAddress ipAddress, int port, object userData)
            {
                ...
                catch (Exception exception)
                {
                    if (NetworkChannelError != null)
                    {
                        ...
                        OnNetworkChannelError(this, NetworkErrorCode.ConnectError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return;
                    }
            ...
            private void ConnectCallback(IAsyncResult ar)
            {
                ...
                OnNetworkChannelConnected(this, socketUserData.UserData);
            ...
            private void SendAsync()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    {
                        SocketException socketException = exception as SocketException;
                        OnNetworkChannelError(this, NetworkErrorCode.SendError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return;
                    }
            ...
            private bool ReceiveSync()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    {
                        SocketException socketException = exception as SocketException;
                        OnNetworkChannelError(this, NetworkErrorCode.ReceiveError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return false;
                    }
