local collector = require 'xuui.collector'
local observeable = require 'xuui.observeable'
local utils = (require 'xuui.utils')

local _M = {}

local load = load or loadstring
local is_template = utils.is_template
local compile_template = utils.compile_template
